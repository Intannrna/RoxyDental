        ...
        <Card>
          <CardHeader className="bg-pink-50 flex flex-row items-center justify-between">
            ...
            <Button
              onClick={() =>
                router.push(
                  `/dashboard/dokter/pasien/detail/${data.id}/tambah-treatment`
                )
              }
                    ...
                    <CardContent className="pt-6">
                      <div className="flex justify-end mb-4 gap-2">
                        <Button
                          onClick={() =>
                            router.push(
                              `/dashboard/dokter/pasien/detail/${data.id}/${treatment.id}/edit-treatment/${treatment.id}`
                            )
                          }
                          variant="outline"
                          size="sm"
